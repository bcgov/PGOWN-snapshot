...
subtitle: "Snapshot Report: July 2024"
...
source("./coding_flow/rcode/timeseries_client.R")
...
write.csv(all_approval_dat, file = "./coding_flow/data/data_new/well_snapshot.csv", row.names = FALSE)
```
...
#Q:? identifier?
well_lookup <- read_excel("./coding_flow/data/data_jb/well_lookup.xlsx", sheet = "well_lookup")
...
number_of_active_wells <- read.csv("./coding_flow/data/data_old/NumberOfWells.csv", stringsAsFactors = F)
...
ggsave("./coding_flow/generated/figures/Fig1_NumberOfWells.png", p1, width = 7, height = 4, units = "in")

write.csv(number_of_active_wells, file = str_c("./coding_flow/generated/figures/", "Fig1_NumberOfWells.csv"), row.names = FALSE)

write.csv(number_of_active_wells, file = str_c("./coding_flow/data/data_new/", "NumberOfWells.csv"), row.names = FALSE)

#read the numer of wells by telemetry type
#read the numer of wells by telemetry type
#Q:? identifier?
tel_stats <- read.csv("./coding_flow/data/data_rc/ow_telem.csv")
...
gtsave(table, "./coding_flow/generated/tables/Tbl1_TelemetryStats.png")

write.table(tel_stats, file = str_c("./coding_flow/generated/tables/", "Tbl1_TelemetryStats.csv"), row.names = FALSE)
...
well_approval <- read.csv(file = "./coding_flow/data/data_new/well_snapshot.csv", stringsAsFactors = F) %>% select("ObsWell", "AgeApprovedDat_Months")
...
ggsave("./coding_flow/generated/figures/Fig2_PercentOfWellsAgeApproved.png", p2, width = 7, height = 4, units = "in")

write.csv(reg_summary, file = str_c("./coding_flow/generated/figures/", "Fig2_PercentOfWellsAgeApproved.csv"), row.names = FALSE)
...
past_per <- read.csv('./coding_flow/data/data_old/well_stats.csv', stringsAsFactors = F)
...
#for next report
write.csv(past_per, "./coding_flow/data/data_new/well_stats.csv", row.names = F)
...
write.csv(past_per, file = str_c("./coding_flow/generated/figures/", "Fig3_ConsecutiveSnapshots.csv"), row.names = FALSE)

ggsave("./coding_flow/generated/figures/Fig3_ConsecutiveSnapshots.png", p3, width = 7, height = 4, units = "in")
```
...
#Q:? identifier?
grading_dat <- read.csv("./coding_flow/data/data_rc/PGOWN_Grades_Appr.csv", stringsAsFactors = F)
...
ggsave("./coding_flow/generated/figures/Fig4_StatusGradingApproval.png", p4, width = 7, height = 4, units = "in")

write.csv(grading_dat, file = str_c("./coding_flow/generated/figures/", "Fig4_StatusGradingApproval.csv"), row.names = FALSE)
...
#data gaps
#Q:? identifier?
data_gaps <- read.csv("./coding_flow/data/data_rc/PGOWN_Gap_Hours.csv", stringsAsFactors = F)
...
write.csv(data_gaps_summary, file = str_c("./coding_flow/generated/figures/", "Fig5_StatusDataGaps.csv"), row.names = FALSE)

ggsave("./coding_flow/generated/figures/Fig5_StatusDataGaps.png", p5, width = 7, height = 4, units = "in")
```
...
#Q:? identifier?
down_tel <- read.csv("./coding_flow/data/data_rc/PGOWN_Telemetry_Latest_Ingest.csv", stringsAsFactors = F)
...
gtsave(table, "./coding_flow/generated/tables/Tbl2_OverviewTelemetry.png")

write.csv(tel_overview, file = str_c("./coding_flow/generated/tables/", "Tbl2_OverviewTelemetry.csv"), row.names = FALSE)
