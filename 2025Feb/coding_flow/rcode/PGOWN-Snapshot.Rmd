...
params <- read_yaml("report_parameter_list.yaml")
...
target_data_gap_year = params$target_data_gap_year
...
target_days_telemetry = as.numeric(params$target_days_telemetry)
...
target_telemetry_stn_offline = as.numeric(params$target_telemetry_stn_offline)


# year when telemetry target was set
#target_days_telemetry_year = Sys.getenv("target_days_telemetry_year")
target_days_telemetry_year = params$target_days_telemetry_year
